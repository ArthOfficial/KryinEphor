...
colors:
  ...
  accent-medium: "rgba(5, 150, 105, 0.16)"
  border: "rgba(5, 150, 105, 0.24)"
  card-bg: "rgba(5, 150, 105, 0.05)"
  positive: "#16A34A"
  negative: "#dc2626"
...
- **Fonts** — already set to **Plus Jakarta Sans** (display) / **Bricolage Grotesque** (body); ignore any preset font name lingering in prose.
